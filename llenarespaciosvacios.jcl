...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>LlenarEspaciosVacios</dc:title>
  </rdf:Description>
</rdf:RDF><version>7</version>

<data>
<title>LlenarEspaciosVacios</title>
...
<gap-fill>Las pruebas <question-record><question></question><answer><text>dinamicas</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> solo se aplican sobre el codigo del producto para detectar defectos y determinar atributos de calidad.

El <question-record><question></question><answer><text>administrador</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> de pruebas es el responsable del exito total de la prueba, involucrando calidad y aprobacion.

Las estrategias de pruebas basadas en <question-record><question></question><answer><text>modelo</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> desarrollan modelos que representan como el sistema deberia comportarse o trabajar.

Las <question-record><question></question><answer><text>revisiones</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> son una tecnica estatica que consiste en realizar un analisis de un documento con el objetivo de encontrar y eliminar errores.

El <question-record><question></question><answer><text>ejecutor</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> de pruebas es el responsable de todas las actividades de las pruebas, implicando verificar y analizar.</gap-fill>
</data>
